...
class BaseThumbnailFieldFile(ImageFieldFile):
    ...
    ``sky_thumbnails.images.ImageProcessor`` or a derived class to
    ...
    def get_identifier(self, identifier):
        if not isinstance(identifier, str) and not isinstance(identifier, str):
...
class EnhancedImageField(ImageField):
    ...
    *django-thumbnail-works* provides an enhanced version of the default Django's
    ...
    # /django/contrib/admin/options.py, line 51
